...
public class Main {
    ...
    public static void main(String[] args) throws MalformedBalanceException {
    ...
    private static Account_W2023_Champions createCheckingAccount(Scanner in) throws MalformedBalanceException {
    ...
    private static Account_W2023_Champions createSavingsAccount(Scanner in) throws MalformedBalanceException {
        System.out.println("Enter Owner Name:");
        String ownerName = in.nextLine();
        System.out.println("Enter balance:");
        double balance = getDouble(in);
